...
8. In de return statement van de App component, map over de todos array en geef voor elke taak een li element weer. 
9. Dit li element bevat een 
10. checkbox voor het wijzigen van de voltooiingsstatus van de taak, 
11. een span element voor het weergeven van de titel van de taak, 
12. en een button voor het verwijderen van de taak. 
13. Gebruik destructuring om de id, titel, voltooide en prioriteit waarden uit elke taak te halen.
